...
A [Jellyfin](https://github.com/jellyfin/jellyfin) companion app for Wear OS that lets you control your media and start new playback sessions straight from your wrist.
...
| Control | Browse |
|---------|--------|
| Play, pause, and stop playback | Browse your media library |
| Fast forward and rewind | Search for content |
| Skip forward | Start playback directly |
...
- [Jellyfin Website](https://jellyfin.org/) - Learn more and get started
